        ...
        <div class="container-xl p-1">
            <?php if (!$hasData): ?>
                ...
                <div class="alert alert-warning alert-dismissible fade show" role="alert">
                    ...
                    <hr>
                    <a href="add-cycle.php" class="btn btn-primary">Add New Cycle</a>
                </div>
            <?php endif; ?>
            ...
            <?php if ($hasData): ?>
            <!-- Calendar Section - Same as result page -->
            <div class="row gx-5">
                ...
                <div class="col-lg-12">
                    <div class="card card-raised">
                        <div class="card-body text-center p-5">
                            <h3 class="text-muted mb-3">📅 Calendar Available After 3 Cycles</h3>
                            <p class="text-muted">Your personalized fertility calendar will appear here once you've recorded 3 valid menstrual cycles.</p>
                            <a href="add-cycle.php" class="btn btn-primary mt-3">Add Cycle Now</a>
                        </div>
                    </div>
                </div>
            </div>
