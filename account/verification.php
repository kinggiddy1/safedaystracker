...
<head>
        ...
        <title>Verification - SAFE DAYS TRACKER</title>
        <!-- Load Favicon-->
                                ...
                                <div class="card card-raised shadow-10 mt-5 mt-xl-10 mb-4">
                                    <div class="card-body p-5">
                                        ...
                                        <form method="post" action="submissions">
                                            <div class="mb-4"><mwc-textfield class="w-100" label="verification codes" outlined="" name="codes"></mwc-textfield></div>
                                            
                                            <div class="form-group d-flex align-items-center justify-content-between mt-4 mb-0">
                                                <button class="btn btn-dark mx-auto" style="background-color: #EC407A;" name="verify" type="submit">Verify</button>
                                            </div>
                                        </form>
                                    </div>
                                </div>
